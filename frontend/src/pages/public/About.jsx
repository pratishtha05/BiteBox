    ...
    <div className="p-6 max-w-6xl mx-auto space-y-12">
      <section className="bg-amber-50 rounded-xl p-6 md:p-10 flex flex-col md:flex-row items-center gap-6">
        <div className="md:w-1/2 space-y-4">
          ...
          <p className="text-gray-700">
            BiteBox is your go-to platform for discovering top-rated
            restaurants, exclusive deals, and fresh meals delivered to your
            doorstep. We make food discovery simple, fast, and delightful.
          </p>
          <p className="text-gray-700">
            From busy weekdays to special occasions, BiteBox ensures you enjoy
      ...
      <section className="grid md:grid-cols-2 gap-6">
        <div className="bg-white shadow rounded-xl p-6 hover:shadow-lg transition">
          ...
          <p className="text-gray-700">
            Connect food lovers with the best local restaurants, providing
            convenience, quality, and unbeatable deals.
          </p>
        </div>
        <div className="bg-white shadow rounded-xl p-6 hover:shadow-lg transition">
          <h2 className="text-xl font-semibold text-gray-900 mb-2">
          ...
          <p className="text-gray-700">
            Be the most trusted and beloved food discovery platform, delighting
            every customer with amazing meals and experiences.
          </p>
        </div>
      </section>
